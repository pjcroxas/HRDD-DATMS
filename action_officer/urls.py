...
urlpatterns = [
	...
	path('database/pendingtrainingreport/', views.pendingtrainingreport, name='pendingtrainingreport'),
	path('database/pendingtrainingreport/<int:pk>', views.updatependingtrainingreport, name='updatependingtrainingreport'),
